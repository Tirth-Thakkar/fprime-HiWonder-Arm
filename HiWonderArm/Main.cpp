...
#include <HiWonderArm/Top/HiWonderArmTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    HiWonderArm::TopologyState inputs;
    ...
    HiWonderArm::setupTopology(inputs);
    HiWonderArm::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    HiWonderArm::teardownTopology(inputs);
